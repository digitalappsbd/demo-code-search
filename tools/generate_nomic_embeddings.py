...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate embeddings using the nomic-ai/nomic-embed-code model")
    ...
    checkpoint_file = os.path.join(project_root, "data", "embeddings_checkpoint.json")
